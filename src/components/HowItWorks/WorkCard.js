...
function WorkCard({ card, stepNumber }) {
  ...
  return (
      ...
      <div className="h-full max-w-[285px] md:max-w-[324px] bg-white rounded-[3px] shadow-worksShadow relative flex flex-col justify-between">
        <div className=" px-4">
          <div className="absolute -top-6 -left-4 w-10 h-10 rounded-full border-[3px] border-[#2B2B2B] bg-white flex items-center justify-center text-gre font-bold text-[24px]">
            {stepNumber}
          </div>
