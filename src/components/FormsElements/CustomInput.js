...
const CustomInput = ({ placeholder = "Enter text", label = "Field label", title = null, description = null, onChange, value = true, setIsButtonDisabled, textError, setTextError }) => {
  const { authorName, setAuthorName } = useContext(CreateBookContext);
  ...
  const handleBlur = () => {
    ...
    authorName ? setIsButtonDisabled(false) : setIsButtonDisabled(true);
  };
