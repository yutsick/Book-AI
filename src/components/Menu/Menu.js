...
const BurgerMenu = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full max-h-[830px] w-60 md:w-[350px] bg-[#f7f2eb] transition-transform duration-300 custom-scrollbar ease-in-out z-[200] overflow-auto ${menuOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
