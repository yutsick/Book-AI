...
const CoverSlider = ({ selectedCover }) => {
  ...
  return (
    ...
    <button
        className="swiper-button-prev-arrow absolute left-5  top-[50%] md:top-1/2 transform md:-translate-y-1/2  z-10 "
        aria-label="Previous Slide"
      >
        <svg width="17" height="14" viewBox="0 0 34 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button
        className="swiper-button-next-arrow absolute right-5  top-[50%] md:top-1/2 transform md:-translate-y-1/2 z-10 "
        aria-label="Next Slide"
      >
        <svg width="17" height="14" viewBox="0 0 33 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="hidden sm:block">
      <button
        className="swiper-button-prev-arrow absolute -left-1 md:left-[-40px] top-1/2 transform md:-translate-y-1/2  z-10 "
        aria-label="Previous Slide"
      >
      ...
      <button
        className="swiper-button-next-arrow absolute right-0 md:right-[-40px] top-1/2 transform md:-translate-y-1/2 z-10 "
        aria-label="Next Slide"
      >
