...
function Choose() {
    ...
    return chooseData ? (
        <section className="bg-pink relative overflow-hidden pb-0 md:pb-[70px]">
            <div
                className="opacity-[65%] absolute left-[-340px] top-[-100px] md:top-[-140px] w-[900px] h-full md:w-[1150px] md:h-[900px] bg-bottom md:bg-center"
                style={{    
            ...
            <div className="relative w-full max-w-[1200px] pt-[40px] md:pt-[50px] pb-[70px] md:pb-[50px]  mx-auto">
            ...
            <div className=" my-[40px]">
                <a
                    className="md:mt-6 max-w-[272px] w-full px-4 bg-orange text-white  h-[55px] mx-auto flex justify-center items-center font-semibold text-[23px] rounded-[3px] gap-1 shadow-heroBtnShadow group z-10"
                    href="/create-book"
                >
