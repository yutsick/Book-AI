...
function Choose() {
    ...
    return chooseData ? (
        <section className="bg-pink relative overflow-hidden pb-0 md:pb-[70px]">
            <div
                className="absolute left-[-340px] top-[-10px] md:top-[-140px] w-[900px] h-full md:w-[1150px] md:h-[900px] bg-bottom md:bg-center"
                style={{
            ...
            <div className="relative w-full max-w-[1200px] pt-[40px] md:pt-[50px] pb-[70px] md:pb-[50px]  mx-auto">
                <h2 className="text-gray text-[30px] md:text-[45px] font-bold text-gray text-center md:text-right mb-[35px] md:mb-[60px] mr-[10px]">{chooseData.title}</h2>
