        ...
        <section className="bg-pink mt-4">
            <div className="max-w-[800px] mx-auto py-[35px] px-[20px]">
                ...
                <div className="text-[16px] space-y-[30px]">
                    <div>
                        <h3 className="font-bold mb-1">Return &amp; Refund Eligibility</h3>
                    ...
                    <div>
                        <h3 className="font-bold mb-1">Non-Refundable &amp; Non-Returnable Items</h3>
                    ...
                    <div>
                        <h3 className="font-bold mb-1">How to Request a Return or Refund</h3>
                        <p>If your book arrives damaged, please follow these steps:</p>
